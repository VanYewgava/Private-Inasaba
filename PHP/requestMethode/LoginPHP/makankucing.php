...
// }
if (isset($_POST["refresh"])) {
    unset($_SESSION["catFood"]); // Hapus hanya pilihan makanan kucing
...
$pilih = isset($_SESSION["catFood"]) && $_SESSION["catFood"] ? $produk[$_SESSION["catFood"]] : null;
